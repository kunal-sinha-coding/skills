...
The supervisor can verify files and process state, but it cannot author the error analysis. Do not configure it as the component responsible for producing the report.
